# Lesson 1.4.2 — OpenShift SCC: the cluster refuses to run the agent
...
cd tutorial/phase1-attacks/chapter-4-openshift/lesson-02-openshift-scc
./run.sh
```
...
Lesson 1.3.1's hardening worked because we wrote a careful spec. Nothing stopped us writing a
...
on vanilla Kubernetes is refused here. That is also why lesson 1.4.1's pod omits it.
...
- [`lesson-03-openshift-kata`](../lesson-03-openshift-kata/) — for the workloads that
