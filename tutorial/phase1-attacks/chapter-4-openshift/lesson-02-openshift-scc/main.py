"""Lesson 1.4.2 — the cluster refuses to run the agent at all.
...
Lesson 1.3.1's hardening worked because we wrote a careful spec. Nothing stopped us writing a careless
...
own `runAsUser` and let OpenShift assign one from the project's range.
    ...
    cd tutorial/phase1-attacks/chapter-4-openshift/lesson-02-openshift-scc && ./run.sh
"""
...
RESULTS = REPO_ROOT / "results" / "1.4.2.json"
NS = "sbx-1-4-2"
SA = "rogue"
