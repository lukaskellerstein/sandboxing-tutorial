# Lesson 1.4.5 — Composition: OpenShell over gVisor on OpenShift (documentation only)
...
Chapter 4 runs OpenShell over Kata for real (lesson 1.4.6), because Kata is what
...
via the sandboxed-containers operator (lesson 1.4.3). With no `runtimeClassName:
