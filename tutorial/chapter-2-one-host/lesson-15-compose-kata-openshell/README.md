# Lesson 15 — Composition: OpenShell over Kata (documentation only)
...
> [chapter 3, lesson 17](../../chapter-3-kubernetes/lesson-17-compose-kata-openshell/README.md)
> and [chapter 4, lesson 19](../../chapter-4-openshift/lesson-19-compose-kata-openshell/README.md).

Kata (lesson 4) gives each workload its own guest kernel; OpenShell (lesson 5)
...
architecture, which is exactly why [lesson 4](../lesson-04-container-kata/README.md)
...
the gVisor stack (lesson 16), and the pair together are the whole composition
