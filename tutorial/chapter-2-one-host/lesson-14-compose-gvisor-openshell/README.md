# Lesson 14 — Composition: OpenShell over gVisor (documentation only)
...
(lesson 3) shrinks the host-kernel attack surface, and OpenShell (lesson 5) adds
...
lesson 5 runs inside a NAT'd guest at all. Composing it over gVisor would need
...
cannot — which is exactly why [lesson 3](../lesson-03-container-gvisor/README.md)
